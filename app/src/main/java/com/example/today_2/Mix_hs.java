...
public class Mix_hs extends AppCompatActivity {
...
//        textView.setText(outputs[0].getRes_name() + outputs[1].getRes_name() + outputs[2].getRes_name());
